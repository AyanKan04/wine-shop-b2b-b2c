...
// In-Memory Database Engine simulating PostgreSQL pool for instant fullstack reactivity
const dbMock = {
  companies: [
    {
      company_id: 1,
...
// 1. Get Products with Deep Filters
...
// 3. Register Company & Upload License
...
// 4. Admin License Approvals
app.get('/api/admin/licenses', (req, res) => {
  res.json({ success: true, data: dbMock.licenses });
});

app.post('/api/admin/licenses/:id/approve', (req, res) => {
