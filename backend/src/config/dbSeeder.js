...
async function seedIfEmpty(sql) {
  try {
    ...
    // Turn IDENTITY_INSERT ON for Companies
    await sql.query`SET IDENTITY_INSERT Companies ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT Companies OFF`;

    // Users
    await sql.query`SET IDENTITY_INSERT Users ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT Users OFF`;

    // CompanyLicenses
    await sql.query`SET IDENTITY_INSERT CompanyLicenses ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT CompanyLicenses OFF`;

    // Products
    await sql.query`SET IDENTITY_INSERT Products ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT Products OFF`;

    // ProductTierPrices
    await sql.query`SET IDENTITY_INSERT ProductTierPrices ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT ProductTierPrices OFF`;

    // Inventories
    await sql.query`SET IDENTITY_INSERT Inventories ON`;
    await sql.query`
      ...
      (4, 104, 320, 40)
    `;
    await sql.query`SET IDENTITY_INSERT Inventories OFF`;

    // CreditLimits
    await sql.query`SET IDENTITY_INSERT CreditLimits ON`;
    await sql.query`
      ...
      (2, 3, 500000000, 0)
    `;
    await sql.query`SET IDENTITY_INSERT CreditLimits OFF`;

    // Orders
    await sql.query`SET IDENTITY_INSERT Orders ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT Orders OFF`;

    // Invoices
    await sql.query`SET IDENTITY_INSERT Invoices ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT Invoices OFF`;

    // Shipments
    await sql.query`SET IDENTITY_INSERT Shipments ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT Shipments OFF`;

    // RFQs
    await sql.query`SET IDENTITY_INSERT RFQs ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT RFQs OFF`;

    // Quotations
    await sql.query`SET IDENTITY_INSERT Quotations ON`;
    await sql.query`
    ...
    `;
    await sql.query`SET IDENTITY_INSERT Quotations OFF`;
