...
async function seedIfEmpty(sql, force = false) {
  try {
    ...
    await sql.query`
      ...
      (104, 2, 'SKU-FR-HENNESSY-XO', N'Hennessy X.O Cognac Extra Old Edition', 'hennessy-xo-cognac', N'Dòng Cognac X.O trứ danh nguyên bản từ năm 1870, phối trộn hơn 100 loại eaux-de-vie lâu năm.', N'France', 40.0, 700, 6, 'ACTIVE', '/assets/images/hennessy.png', GETDATE(), GETDATE()),
